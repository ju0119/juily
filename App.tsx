...
// Fix: Use namespace import for react-router-dom to resolve "no exported member" errors in the environment
...
const { HashRouter, Routes, Route, Navigate, Link, useNavigate } = Router as any;
